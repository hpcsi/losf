...
export IGNORE_PKGS="kernel*;libibcm*;libibcommon*;libibverbs*;libipathverbs*;libmthca*;libopensm*;libosmcomp*;libosmvendor*;librdmacm*;mstflint*;opensm*;libibumad*;openib*;ibutils*;libsdp*;iscsi-initiator-utils;libcxgb3"
